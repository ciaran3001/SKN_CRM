  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'selectForeign' => 
        array (
          'sql' => '{alias}.total * totalCurrencyRateInvoice{alias}Foreign.rate',
          'leftJoins' => 
          array (
            0 => 
            array (
              0 => 'Currency',
              1 => 'totalCurrencyRateInvoice{alias}Foreign',
              2 => 
              array (
                'totalCurrencyRateInvoice{alias}Foreign.id:' => '{alias}.totalCurrency',
              ),
            ),
          ),
        ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'orderBy' => 
        array (
          'sql' => 'order_items.price * priceCurrencyRate.rate {direction}',
          'leftJoins' => 
          array (
            0 => 
            array (
      ...
      array (
        ...
        'orderBy' => 
        array (
          'sql' => 'order_items.sell_price * sellPriceCurrencyRate.rate {direction}',
          'leftJoins' => 
          array (
            0 => 
            array (
              0 => 'Currency',
              1 => 'sellPriceCurrencyRate',
              2 => 
              array (
                'sellPriceCurrencyRate.id:' => 'sellPriceCurrency',
              ),
            ),
          ),
          'additionalSelect' => 
          array (
            0 => 'sellPriceCurrencyRate.rate',
          ),
        ),
        'attributeRole' => 'value',
      ),
      ...
      array (
        ...
        'select' => 
        array (
          'sql' => 'order_items.price * priceCurrencyRate.rate',
          'leftJoins' => 
          array (
            0 => 
            array (
        ...
        'selectForeign' => 
        array (
          'sql' => '{alias}.price * priceCurrencyRateOrderItems{alias}Foreign.rate',
          'leftJoins' => 
          array (
            0 => 
            array (
              0 => 'Currency',
              1 => 'priceCurrencyRateOrderItems{alias}Foreign',
              2 => 
              array (
                'priceCurrencyRateOrderItems{alias}Foreign.id:' => '{alias}.priceCurrency',
              ),
            ),
          ),
        ),
        ...
        array (
          '=' => 
          array (
            'sql' => 'order_items.price * priceCurrencyRate.rate = {value}',
            'leftJoins' => 
            array (
              0 => 
              array (
          ...
          'IS NULL' => 
          array (
            'sql' => 'order_items.price IS NULL',
          ),
          'IS NOT NULL' => 
          array (
            'sql' => 'order_items.price IS NOT NULL',
          ),
        ),
        'notStorable' => true,
        'orderBy' => 
        array (
          'sql' => 'priceConverted {direction}',
          'leftJoins' => 
          array (
            0 => 
            array (
      ...
      array (
        ...
        'select' => 
        array (
          'sql' => 'order_items.sell_price * sellPriceCurrencyRate.rate',
          'leftJoins' => 
          array (
            0 => 
            array (
        ...
        'selectForeign' => 
        array (
          'sql' => '{alias}.sell_price * sellPriceCurrencyRateOrderItems{alias}Foreign.rate',
          'leftJoins' => 
          array (
            0 => 
            array (
              0 => 'Currency',
              1 => 'sellPriceCurrencyRateOrderItems{alias}Foreign',
              2 => 
              array (
                'sellPriceCurrencyRateOrderItems{alias}Foreign.id:' => '{alias}.sellPriceCurrency',
              ),
            ),
          ),
        ),
        ...
        array (
          '=' => 
          array (
            'sql' => 'order_items.sell_price * sellPriceCurrencyRate.rate = {value}',
            'leftJoins' => 
            array (
              0 => 
              array (
          ...
          'IS NULL' => 
          array (
            'sql' => 'order_items.sell_price IS NULL',
          ),
          'IS NOT NULL' => 
          array (
            'sql' => 'order_items.sell_price IS NOT NULL',
          ),
        ),
        'notStorable' => true,
        'orderBy' => 
        array (
          'sql' => 'sellPriceConverted {direction}',
          'leftJoins' => 
          array (
            0 => 
            array (
